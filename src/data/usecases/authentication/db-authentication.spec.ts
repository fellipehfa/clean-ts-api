...
import { AccountModel, AuthenticationModel, HashCompare, LoadAccountByEmailRepository, TokenGenerate, UpdateAccessTokenRepository } from './db-authentication-protocols'
